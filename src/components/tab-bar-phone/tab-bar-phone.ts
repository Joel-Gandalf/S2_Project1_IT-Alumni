...
export const createTabBar = (): Element | null => {
    ...
    <ul>
      <li>
        <button class="button-link active" aria-label="Ir a inicio">
      ...
      <li>
        <button class="button-link" aria-label="Ir a la red de exalumnos">
      ...
      <li>
        <button class="button-link" aria-label="Ir al portal laboral">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <button class="button-link" aria-label="Ir a perfil">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
